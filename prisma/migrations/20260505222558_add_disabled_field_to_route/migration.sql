/*
  ...
  - Added the required column `disabled` to the `Route` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Route" ("allowAllRequests", "id", "path", "serviceid") SELECT "allowAllRequests", "id", "path", "serviceid" FROM "Route";
DROP TABLE "Route";
